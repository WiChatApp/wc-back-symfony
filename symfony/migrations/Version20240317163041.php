...
final class Version20240317163041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assignation (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, permission_id INT NOT NULL, chat_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_D2A03CE0D60322AC (role_id), INDEX IDX_D2A03CE0FED90CCA (permission_id), INDEX IDX_D2A03CE01A9A7125 (chat_id), INDEX IDX_D2A03CE0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE assignation ADD CONSTRAINT FK_D2A03CE0D60322AC FOREIGN KEY (role_id) REFERENCES role (id)');
        $this->addSql('ALTER TABLE assignation ADD CONSTRAINT FK_D2A03CE0FED90CCA FOREIGN KEY (permission_id) REFERENCES permission (id)');
        $this->addSql('ALTER TABLE assignation ADD CONSTRAINT FK_D2A03CE01A9A7125 FOREIGN KEY (chat_id) REFERENCES chat (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assignation DROP FOREIGN KEY FK_D2A03CE0D60322AC');
        $this->addSql('ALTER TABLE assignation DROP FOREIGN KEY FK_D2A03CE0FED90CCA');
        $this->addSql('ALTER TABLE assignation DROP FOREIGN KEY FK_D2A03CE01A9A7125');
